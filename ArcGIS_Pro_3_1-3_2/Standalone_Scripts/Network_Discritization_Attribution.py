...
if usegui==False:
    ...
    strm=r"D:\test\a000\a000_stream_5km.shp"
    # input flow accumulation raster
    fac=r"D:\test\a000\a000fac.tif"
    # input filled dem
    demf=r"D:\test\a000\a000demf.tif"
    # length for each line segment
    s_len=500
    slope_thresh=10**-3 # minimum slope
    # output directory
    out_dir=r"D:\test\a000"
...
arcpy.SplitLineAtPoint_management(out_tmp_id+"_streamdiss.shp", out_tmp_id+"_XYbreakall.shp", out_tmp_id+"split.shp", str(tol))
