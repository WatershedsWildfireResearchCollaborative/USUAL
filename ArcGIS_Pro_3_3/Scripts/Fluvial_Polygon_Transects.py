...
if usegui==False:
    #input polygon
    infcpol=r'C:\\shapefiles\DFk_valley.shp'
    #input centerline
    infccnt=r'C:\\shapefiles\DFk_valley_centerline.shp'
    # point spacing to generate transects
    tranden=5
    #polygon that overlaps input polygon where points will not be generated
    exludeaoi=[]#optional set to [] if not using#r'D:\test\area2exlclude.shp'
    # removes all points with x distance of intersection of centerline and polygon
    rmprad=10#optional set to [] if not using
    #output directory
    out_dir=r"C:\\outputs"
